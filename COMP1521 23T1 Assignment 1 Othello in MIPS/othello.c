 ...
 *
 * Prior to translating this program into MIPS assembly, you may wish to make a
 * copy of this C program and call it `othello.simple.c`. In it, you can replace
...
int play_turn(void) {
    ...
    scanf(" %c%d", &move_col_letter, &move_row);
